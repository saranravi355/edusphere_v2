              ...
              {quiz.attempts.length === 0 ? (
                ...
                quiz.attempts.map((a) => (
                  <tr key={a.id} className="border-b border-slate-100 dark:border-slate-800/50">
                    ...
                    <td className="p-4 text-slate-600 dark:text-slate-400">{a.autoSubmitted ? "Auto-submitted" : "Submitted"} {a.submittedAt.toLocaleDateString('en-GB', { timeZone: "Asia/Kolkata" })}</td>
