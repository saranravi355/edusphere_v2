...
// MYP: the same student's weakest Mathematics topics as the Learning Gap Map
// and the practice paper — probability first.
const MYP: Content = {
  ...SHARED,
  result: {
    kind: "document",
    heading: "Revision sheet — MYP Mathematics",
    sections: [
      {
        heading: "Probability of combined events (weakest topic)",
        lines: [
          "Multiply along the branches of a tree diagram; add across the branches that give the outcome you want.",
          "Without replacement, the second set of branches has one fewer item in every denominator — the most common slip.",
          "Practice: 3 red and 5 blue counters, two taken without replacement. Find the probability of one of each colour.",
        ],
      },
      {
        heading: "Simultaneous equations",
        lines: [
          "Eliminate one variable by adding or subtracting the equations — scale one first if the coefficients do not match.",
          "Check your answer in the equation you did not use to finish.",
          "Common slip in your last two tests: sign errors when subtracting a negative.",
        ],
      },
      {
        heading: "Pythagoras' theorem",
        lines: [
          "It applies only to right-angled triangles; the hypotenuse is the side opposite the right angle.",
          "Square the two shorter sides, add, then take the square root — never add the sides first.",
        ],
      },
    ],
  },
...
export default function RevisionGeneratorPage() {
  ...
  return <AIDemoPage icon={NotebookPen} {...content} />;
}
