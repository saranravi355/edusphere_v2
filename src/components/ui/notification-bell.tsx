...
/*
 * Rare UI's notification bell (MIT) — rareui.com, swamimalode07/rare-ui.
 * Vendored rather than installed: the shadcn CLI wanted to overwrite lib/utils.ts,
 * which carries our own helpers. Imports come from framer-motion rather than the
 * newer "motion" package so the app ships one animation runtime, not two; the two
 * are the same library and every hook used here exists in both.
 *
 * Local changes are marked EDUSPHERE.
 */
