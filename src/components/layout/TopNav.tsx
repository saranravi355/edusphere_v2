...
export default function TopNav({ user }: { user: any }) {
  ...
  const roleLinks = {
    SUPER_ADMIN: [
      ...
      { name: "Timetable AI", href: "/admin/academic-setup/timetable-ai", icon: BrainCircuit },
      ...
      <header className="h-16 flex items-center justify-between px-6 lg:px-10">
        <div className="flex items-center gap-6">
          ...
          <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-zinc-900 dark:hover:bg-zinc-800 rounded-xl text-sm font-medium text-slate-500 transition-colors cursor-pointer">
            ...
            <span className="ml-4 text-xs bg-white dark:bg-black px-1.5 py-0.5 rounded shadow-sm">Ctrl+K</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 lg:gap-6">
          ...
          <div className="relative group">
            ...
            <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-black border border-slate-200 dark:border-zinc-800 shadow-lg rounded-xl overflow-hidden hidden group-hover:block z-50 animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="p-2 bg-slate-50 dark:bg-zinc-900/50 text-center">
                <span className="text-xs font-medium text-slate-500 hover:text-slate-800 dark:hover:text-slate-300 cursor-pointer">View all</span>
              </div>
            </div>
          </div>
